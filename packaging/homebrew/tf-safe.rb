...
class TfSafe < Formula
  ...
  homepage "https://github.com/your-org/tf-safe"
  version "1.0.0"
  
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/your-org/tf-safe/releases/download/v#{version}/tf-safe-darwin-arm64.tar.gz"
      sha256 "REPLACE_WITH_ACTUAL_SHA256_FOR_ARM64"
    else
      url "https://github.com/your-org/tf-safe/releases/download/v#{version}/tf-safe-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/your-org/tf-safe/releases/download/v#{version}/tf-safe-linux-arm64.tar.gz"
      sha256 "REPLACE_WITH_ACTUAL_SHA256_FOR_LINUX_ARM64"
    else
      url "https://github.com/your-org/tf-safe/releases/download/v#{version}/tf-safe-linux-amd64.tar.gz"
